...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { label: 'Session isolation', included: false },
      { label: 'Live orders & sounds', included: false },
      { label: 'Waiter calling system', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Session isolation', included: true },
      { label: 'Live orders & sounds 🔔', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Session isolation', included: true },
      { label: 'Live orders & sounds 🔔', included: true },
      { label: 'Waiter calling system 🛎️', included: true },
      { label: 'Session funnel analytics', included: true },
